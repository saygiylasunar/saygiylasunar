...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/logbook', name: 'logbook', component: () => import('../views/LogbookView.vue'), meta: { seoKey: 'logbook' } },
    { path: '/logbook/:slug', name: 'logbook-detail', component: () => import('../views/LogbookDetailView.vue'), meta: { seoKey: 'logbook' } },
